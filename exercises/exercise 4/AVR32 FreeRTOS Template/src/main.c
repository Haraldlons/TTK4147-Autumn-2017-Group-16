...
static void responseA(void *pvParameters);
static void responseB(void *pvParameters);
static void responseC(void *pvParameters);
static void responseAPolling(void *pvParameters);
static void responseBPolling(void *pvParameters);
static void responseCPolling(void *pvParameters);
...
int main()
{
	...
	// start basic task
	xTaskCreate( responseAPolling, (signed char * ) "BASIC", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	xTaskCreate( responseBPolling, (signed char * ) "BASIC", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	xTaskCreate( responseCPolling, (signed char * ) "BASIC", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
...
{
	const portTickType xDelay = 1 / portTICK_RATE_MS;
	const portTickType xFreq = 5 / portTICK_RATE_MS;
